...
CREATE TABLE SpotifyClone.favorited_artists(
user_id INT NOT NULL,
artist_id INT NOT NULL,
...
INSERT INTO SpotifyClone.users(name, age, plan_id, sub_date)
...
INSERT INTO SpotifyClone.albuns(name, artist_id, release_year)
...
INSERT INTO SpotifyClone.songs(name, album_id, artist_id, duration_seconds)
VALUES ('BREAK MY SOUL', 1, 1, 279),
...
INSERT INTO SpotifyClone.play_history(user_id, song_id, date)
...
INSERT INTO SpotifyClone.favorited_artists(user_id, artist_id)
VALUES (1, 1),
		(1, 2),
        (1, 3),
        (2, 1),
